...
/// checked 2026-08-26). Update the table when prices move.
...
public let codexPricingTable: [String: ModelPricing] = [
    "gpt-5.6-sol":   ModelPricing(input: 4.00, cachedInput: 0.40, output: 20.00),
    "gpt-5.6-terra": ModelPricing(input: 2.00, cachedInput: 0.20, output: 12.00),
    "gpt-5.6-luna":  ModelPricing(input: 0.20, cachedInput: 0.02, output: 1.20),
    "gpt-5.4":       ModelPricing(input: 2.50, cachedInput: 0.25, output: 15.00),
    "gpt-5.4-mini":  ModelPricing(input: 0.75, cachedInput: 0.075, output: 4.50),
    "gpt-5.3-codex": ModelPricing(input: 1.75, cachedInput: 0.175, output: 14.00),
]
...
public let fallbackPricing = ModelPricing(input: 2.00, cachedInput: 0.20, output: 12.00)
...
public func pricing(forModel model: String?) -> ModelPricing {
    guard let model, !model.isEmpty else { return fallbackPricing }
...
public func costOfTurn(_ t: CodexTurn) -> Double {
    let p = pricing(forModel: t.model)
...
/// Default framing: ~$100/month of Codex is normal; over 2× that is heavy.
